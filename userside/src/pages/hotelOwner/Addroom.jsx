      ...
      <div className='w-full flex max-sm:flex-col sm:gap-4 mt-1'>
        <div className='flex-1 max-w-48'>
          ...
          <select value={inputs.roomType} onChange={e=>setInputs({...inputs,roomType:e.target.value})}
            className='border opacity-70 border-gray-300 my-1 rounded p-2 w-full'>
            <option value="">Select Room Type</option>
            <option value="Signle Bed">Single Bed</option>
      ...
      <div className='flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm'>
        {Object.keys(inputs.amenities).map((amenity,index)=>(
          <div key={index}>
            ...
            {inputs.amenities[amenity]} onChange={()=>setInputs({...inputs,amenities:
