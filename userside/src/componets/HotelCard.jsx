...
export const HotelCard = ({room,index}) => {
    return (
        <div>  
        <Link to={'/rooms/'+room._id} onClick={()=>scrollTo()} key={room._id}  className='w-69 shrink-0 flex flex-col relative rounded-xl overflow-hidden bg-white text-gray-800 shadow-[0px_4px_4px_rgba(0,0,0,0.05)]' >
