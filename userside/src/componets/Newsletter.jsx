...
export default function Newsletter() {
    return (
        <>
            ...
            `}</style>
            <div className="mt-12 mb-12 md:mt-20 md:mb-24 py-6 md:py-10">
            <div className="max-w-5xl py-16 md:pl-20 md:w-full mx-2 md:mx-auto p-4 flex flex-col md:flex-row items-center justify-between text-left bg-gradient-to-b from-[#0b0f14] to-[#071034] rounded-2xl md:p-10 text-white">
                <div>
                    <div>
                        <p className="text-slate-300">Trusted by 4k+ Guest</p>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-slate-300">4.5/5 • 1300+ Reviews</span>
                        </div>
                    </div>
